...
const ProfilePage = () => {
    const { userData, setUserData, LogOut, isAdmin } = useContext(Context);
    ...
    return (
        ...
        <div className="profile-container">
            <div className="profile-card">
                {(!isAdmin)?<h1 className="profile-title">User Profile</h1>:<h1 className="profile-title">Admin Profile</h1>}
